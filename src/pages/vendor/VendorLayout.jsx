    ...
    `}>
      <div className="p-6 border-b border-white/10">
        <Link to="/" className="flex items-center gap-2">
          <Logo onDark subtitle="Vendor Portal" />
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-3 py-2 mb-2">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-gray-400">Event Organiser</p>
          </div>
        </div>
        <button
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="bg-white border-b border-gray-100 px-4 sm:px-6 h-16 flex items-center justify-between shrink-0">
          <button onClick={() => setSidebarOpen(true)} className="lg:hidden p-2 text-gray-600 hover:bg-gray-100 rounded-xl">
